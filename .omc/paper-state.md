...
round: 3/3
last-critic-verdict: pass
last-critic-issues: round 3 verdict pass. Carry-forward to novelty-check (not a lit-review blocker): search the additive-residual structure under "gray-box"/"semi-parametric"/"hybrid mechanistic-ML" terminology, not just "PINN"; the paywalled ScienceDirect review (PII S2590123026034018, "hybrid vs non-hybrid" fouling ML survey) remains an open, user-accepted risk - not registered, no DOI resolved.
